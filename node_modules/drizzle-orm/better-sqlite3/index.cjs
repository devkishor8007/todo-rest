...
var _a, _b, _c;
class BetterSQLiteSession extends uniqueConstraint.SQLiteSession {
...
class BetterSQLiteTransaction extends uniqueConstraint.SQLiteTransaction {
...
function drizzle(client, config = {}) {
    const dialect = new uniqueConstraint.SQLiteSyncDialect();
    let logger;
    ...
    return new uniqueConstraint.BaseSQLiteDatabase('sync', dialect, session, schema);
}
