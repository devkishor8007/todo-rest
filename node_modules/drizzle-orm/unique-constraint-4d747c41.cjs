...
_a$m = alias.entityKind, alias.Table.Symbol.Columns, _b$j = InlineForeignKeys, _c$8 = alias.Table.Symbol.ExtraConfigBuilder;
...
ManualViewBuilder[_c$7] = 'SQLiteManualViewBuilder';
...
SQLiteAsyncDialect[_c$6] = 'SQLiteAsyncDialect';
...
SQLiteSelect[_c$5] = 'SQLiteSelect';
...
SQLiteRelationalQuery[_c$4] = 'SQLiteRelationalQuery';
...
SQLiteColumnBuilder[_a$a] = 'SQLiteColumnBuilder';
...
SQLiteColumn[_b$a] = 'SQLiteColumn';

var _a$9, _b$9, _c$3, _d$1, _e$1, _f$1;
...
SQLiteBigIntBuilder[_a$9] = 'SQLiteBigIntBuilder';
...
SQLiteBigInt[_b$9] = 'SQLiteBigInt';
...
SQLiteCustomColumnBuilder[_a$8] = 'SQLiteCustomColumnBuilder';
...
SQLiteCustomColumn[_b$8] = 'SQLiteCustomColumn';
/**
...
var _a$7, _b$7, _c$2, _d, _e, _f, _g, _h;
...
SQLiteBaseIntegerBuilder[_a$7] = 'SQLiteBaseIntegerBuilder';
...
SQLiteBaseInteger[_b$7] = 'SQLiteBaseInteger';
...
SQLiteNumericBuilder[_a$6] = 'SQLiteNumericBuilder';
...
SQLiteNumeric[_b$6] = 'SQLiteNumeric';
...
SQLiteRealBuilder[_a$5] = 'SQLiteRealBuilder';
...
SQLiteTextBuilder[_a$4] = 'SQLiteTextBuilder';
...
IndexBuilderOn[_a$3] = 'SQLiteIndexBuilderOn';
class IndexBuilder {
...
IndexBuilder[_b$3] = 'SQLiteIndexBuilder';
class Index {
...
PrimaryKeyBuilder[_a$2] = 'SQLitePrimaryKeyBuilder';
class PrimaryKey {
...
PrimaryKey[_b$2] = 'SQLitePrimaryKey';

var _a$1, _b$1, _c;
let PreparedQuery$1 = class PreparedQuery {
};
_a$1 = alias.entityKind;
PreparedQuery$1[_a$1] = 'PreparedQuery';
class SQLiteSession {
    constructor(
    /** @internal */
    dialect) {
...
SQLiteSession[_b$1] = 'SQLiteSession';
...
_a = alias.entityKind;
UniqueBuilder[_a] = 'SQLiteUniqueBuilder';
class Unique {
    constructor(table, builder) {
        this.table = table;
        this.name = builder.name;
...
exports.view = view;
//# sourceMappingURL=unique-constraint-4d747c41.cjs.map
