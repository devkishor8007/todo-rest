import { M as TableAliasProxyHandler, e as entityKind, L as ColumnBuilder, C as Column, s as sql, T as Table, i as is, u as ViewBaseConfig } from '../alias-3edfcde9.mjs';
import { d as SQLiteTable, e as SQLiteViewConfig } from '../session-94bf2069.mjs';
export { B as BaseSQLiteDatabase, I as InlineForeignKeys, M as ManualViewBuilder, P as PreparedQuery, Q as QueryBuilder, c as SQLiteAsyncDialect, g as SQLiteDelete, f as SQLiteDialect, i as SQLiteInsert, h as SQLiteInsertBuilder, l as SQLiteSelect, j as SQLiteSelectBuilder, k as SQLiteSelectQueryBuilder, S as SQLiteSession, b as SQLiteSyncDialect, a as SQLiteTransaction, n as SQLiteUpdate, m as SQLiteUpdateBuilder, r as SQLiteView, q as SQLiteViewBase, p as ViewBuilder, V as ViewBuilderCore, s as sqliteTable, o as sqliteTableCreator, t as sqliteView, v as view } from '../session-94bf2069.mjs';
...
class UniqueBuilder {
    name;
    column;
    static [entityKind] = 'SQLiteUniqueBuilder';
...
class Unique {
    table;
    static [entityKind] = 'SQLiteUnique';
    name;
    column;
    constructor(table, builder) {
        this.table = table;
